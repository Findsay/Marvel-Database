...
-- SELECT name FROM people WHERE name = 'Fiona	Lindsay';
...
-- 11. Command for deleting multiple entries on one line

-- DELETE FROM movies WHERE title IN ('Guardians of the Galaxy 2', 'Iron Man');
-- SELECT * FROM movies;
--
-- id |                title                | year | show_time
-- ----+-------------------------------------+------+-----------
